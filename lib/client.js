	...
	factory: (require) => {
		...
		*/
		...
		function DefaultCard({ section, onChange, saved, disabled }) {
			...
			const [fileRoles, setFileRoles] = (0, react.useState)([]);
			const [fileRolesLoadFailed, setFileRolesLoadFailed] = (0, react.useState)(false);
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								...
								children: [
									...
									fileRoles.filter((r) => r.source === "project-md").length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("optgroup", {
										label: "项目 agent md",
										children: fileRoles.filter((r) => r.source === "project-md").map((r) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
											value: r.id,
											children: [
												r.id,
												" — ",
									...
									fileRoles.filter((r) => r.source === "global-md").length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("optgroup", {
										label: "全局 agent md",
										children: fileRoles.filter((r) => r.source === "global-md").map((r) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
											value: r.id,
											children: [
												r.id,
												" — ",
									...
									roleEntries.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("optgroup", {
										label: "设置",
										children: roleEntries.map(([id, role]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
											value: id,
											children: [
												id,
												" — ",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dsp-card-meta",
								children: saved["defaultRole"] === true ? "已保存" : fileRolesLoadFailed ? "（file roles 加载失败）" : ""
							})
						]
					})
				]
